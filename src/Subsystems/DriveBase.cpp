...
void DriveBase::TankDrive() {
	DriveBase::leftMotor1->Set(Robot::oi->getJoystick1()->GetY()*-1);
	DriveBase::leftMotor2->Set(Robot::oi->getJoystick1()->GetY()*-1);
	DriveBase::rightMotor1->Set(Robot::oi->getJoystick2()->GetY());
	DriveBase::rightMotor2->Set(Robot::oi->getJoystick2()->GetY());
}
